...
import com.qataskmanager.automation_sut.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TestDataImportException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse testDataImport(TestDataImportException exception, HttpServletRequest request) {
        return ErrorResponse.validation(400, "Bad Request", exception.getMessage(), request.getRequestURI(), exception.getValidationErrors());
    }
